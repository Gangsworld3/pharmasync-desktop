    ...
    overlap_booking = await async_client.post(
        ...
        json=_sync_payload(
            ...
            data={
                ...
                "service_type": "Consultation",
                "staff_name": "Dr. Lemi",
                "starts_at": "2026-03-29T10:30:00+02:00",
                "ends_at": "2026-03-29T11:30:00+02:00",
                "status": "PENDING",
            },
        ),
    )
        ...
        if operation == "update_client":
            ...
            change = {
                ...
                "data": {
                    ...
                    "starts_at": f"2026-04-01T{start_hour:02d}:00:00+02:00",
                    "ends_at": f"2026-04-01T{start_hour + duration_hours:02d}:00:00+02:00",
                    "status": "PENDING",
                },
            }
            await push_change(device_id, change)
